<x-layout-base>
    ...
    <x-slot:titlePage>Supplier</x-slot:titlePage>
    <x-slot:headerFiles>
    ...
    <x-slot:renderContent>
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title fs-21 mb-1">Supplier Master</h5>
                <nav>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control text-field" id="txtName" placeholder="Enter Name" autocomplete="off" maxlength="100" />
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/js/pages/masters/supplier.js'])
    </x-slot>
</x-layout-base>
